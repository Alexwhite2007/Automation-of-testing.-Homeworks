...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет (POST) запрос на сервер данные о добавляемом питомце и возвращает статус
    ...
    def add_new_pet_simple_without_photo(self, auth_key: json, name: str,
                                         animal_type: str, age: str) -> json:
        """Метод отправляет (POST) запрос на сервер данные о добавляемом питомце без фото и возвращает статус
                запроса на сервер и результат в формате JSON с данными добавленного питомца"""
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод добавляет фото по указанному ID питомца и возвращает статус запроса
